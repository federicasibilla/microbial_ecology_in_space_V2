"""
example_two_aux.py: script to run the spatial simulation of two species, where both consume
the primary carbon source, but they needeaxh other for the exchange of an essential building block
to see the effect of space, they have different 'intrinsic growth rates' (i.e. energy to biomass conversion factors)
...
# matrices of this specific system
